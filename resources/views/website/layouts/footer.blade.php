        ...
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-14 col-sm-12 ">
                <div class="footer-widget">
                    <img src="{{url('RUBICSOL.png')}}" class="img-fluid" alt="" width="100">

                    <p class="mb-0 mt-4">Rubi Plaza, Awan Chowk, Near Akbar Chowk, Faisalabad</p>
                    <p class="mb-0">Phone: +9230001235321, +923040647306</p>
                    <p class="mb-0">Email: info@rubicsol.com</p>
                </div>
            </div>

...
@section('content')
        ...
        <div class="container">
            <div class="row ">
                <div class="col-md-12 text-center">
                    <h2 class="mb-2 text-lg text-center mt-5">About RUBICSOL</h2>

                    <h5>Providing Quality-proof Adaptable Lab Solutions</h5>
                </div>
            </div>
            <div class="row mt-5">
                <div class="col-lg-8">
            ...
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <div class="section-heading">
                        <h2 class="mb-2 text-lg text-center pt-5">Our Mission</h2>
                        <h5 class=" text-center">Explore Laboratory Management: Unleash the potential of RUBIC LIMS</h5>
                        <div class="row pt-5">
    ...
    <section class="section contact py-5 mt-5" id="contact">
        <div class="container">
            <div class="row ">
                <div class="col-md-12 text-center">
                    <h2 class="mb-2 text-lg text-center mt-5 ">Our Vision</h2>

                    <h5>Vision to Victory</h5>
                </div>
            </div>
            <div class="row mt-5">

        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header border-bottom">
                    ...
                    <a href="{{url('email/template')}}" class="float-right btn btn-primary ml-1">Template</a>
                    <a href="{{url('email/template1')}}" class="float-right btn btn-primary ml-1">Template1</a>
                </div>

                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div style="display: flex">
                                        <img src="http://aimslims.com/4.png" onclick="window.location.href=$(this).attr('src')" width="45%" alt="" style="margin-right: 20px">
                                        <img src="http://aimslims.com/1.png" onclick="window.location.href=$(this).attr('src')" width="45%" alt="">
                                    </div>
                                    <div style="display: flex;margin-top: 20px" >
                                        <img src="http://aimslims.com/2.png" onclick="window.location.href=$(this).attr('src')" width="45%" alt="" style="margin-right: 20px">
                                        <img src="http://aimslims.com/3.png" onclick="window.location.href=$(this).attr('src')" width="45%" alt="">
                                    </div>
                                    <div style="display: flex;margin-top: 20px" >
                                        <img src="http://aimslims.com/5.png" onclick="window.location.href=$(this).attr('src')" width="45%" alt="">
                                    </div>

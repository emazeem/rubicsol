...
=======
    <div class="col-12 mb-2">
        <h3 class="float-left pb-1 font-weight-light"><i class="feather icon-users"></i> 
        Attendance</h3>
    ...
    <div class="col-lg-12 table-responsive">
      ...
      @if(count($attendances)>0)
        ...
        <tr class="table-row">
            ...
            @else
            <td><a href="{{route('attendance.show',['id'=>$attendance->id])}}" class="btn btn-warning btn-sm ml-3" ><i class="fas fa-eye"></i></a></button></td>
            @endif
        </tr>
        @endforeach
        @else
...
>>>>>>> 03d4a1bf813933e0d98dd91e8a5fc185955260a5
 </div>
